...
**Vercel:** 대시보드에서 Git LFS를 켜야 배포 빌드에 실 JSON이 포함된다. ([Git settings](https://vercel.com/docs/project-configuration/git-settings)) 라우터 오류·대용량 이슈는 `docs/VERCEL-TROUBLESHOOTING.md`, 외부 URL은 `VITE_EV_STATIONS_SUMMARY_URL` + CSP `connect-src` 추가.
